...
from dataloader import VectorTrainerForgetting, custom_data_collator_forget
import torch
...
def main(cfg):
    ...
    # for npo
    forget_mask_path = cfg.mask_path.forget
    retain_mask_path = cfg.mask_path.retain
    ...
    trainer = VectorTrainerForgetting(
        ...
        retain_mask_path = retain_mask_path,
        relation = relation,
        forget_vector_path = forget_vector_path,
        retain_vector_path = retain_vector_path,
    )
